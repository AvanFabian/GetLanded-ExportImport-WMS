            ...
            <div class="hidden lg:flex w-1/2 bg-gray-900 relative user-select-none">
                ...
                <div class="relative z-10 w-full flex flex-col justify-center px-12 text-white">
                    <div class="flex items-center space-x-2">
                        <div class="w-10 h-10 bg-emerald-600 rounded-lg flex items-center justify-center shadow-lg shadow-emerald-500/20">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                        </div>
                        <span class="text-2xl font-bold text-gray-900 tracking-tight">GetLanded</span>
                    </div>
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="flex justify-center mb-8 lg:hidden">
                        <a href="/" class="flex items-center gap-2">
                            ...
                            <span class="text-2xl font-bold text-gray-900">{{ config('app.name', 'GetLanded') }}</span>
                        </a>
                    </div>
